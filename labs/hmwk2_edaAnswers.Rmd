...
1.  [1] Create a subset of tidywho that only includes the ASEAN nations.  Name this `whoasean`. Note that the list of nations and the corresponding ISO codes is provided below. You will need the package `countrycode` to make this work.
...
2.  [12] Group and plot the total rate of diagnosis of TB per year for each country in a form that is comparable. 
