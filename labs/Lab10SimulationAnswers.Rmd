...
c. [3] Simulate each method 250 days (replications).  Show the results using a plot that shows variance. (remember to add titles and labels)  Which is the best in reducing lateness?

Hint: create a `for` loop that iterates 250 days. For each day, generate a joblist and apply each sequencing method to it. And save the results to lists that you will combine into a data frame.
