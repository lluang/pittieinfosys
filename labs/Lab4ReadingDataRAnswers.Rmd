...
To save effort, only use the variables corresponding to new positive pulmonary smear.

Note, your first line should select the columns that you are interested in.
```{r}
...
3. [3] Using the original WHO data, use the `who` and `population` tables together to create a table with the name of the country, iso3, year and population.  Display the last 6 rows of the table (which should be Zimbabwe)
