...
This lab uses the ACS Public Use Microdata Sample (PUMS) data for Pittsburgh, North for 2012 (your version of Excel is not able to handle all of the PA that you used last week).  Create a new Access database importing Pittsburgh data. You should have the same result (housing data was imported, person data generated an error).  The data dictionary is at 
...
```
NOTE: the students will have different values in the top four. The structure must be correct (SQL has no guarantees on the order).
...
3.  [2] New York City recently instituted universal Pre-Kindergarden (Pre-school) for four year-olds.  What is the fraction of 4 and 5 year olds in Pre-school in Allegheny County? 
