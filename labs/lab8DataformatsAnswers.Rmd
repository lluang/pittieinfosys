...
head(beaver1$date)
```
2. [2] Look at the time stamps. What makes this hard to work with. Write out an algorithm (in pseudocode or a process map) that would converts this time into the R time format.  Then code this in R.
