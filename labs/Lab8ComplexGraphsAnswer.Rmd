...
1.  [3] One question when looking at population demographics is if all parts of the population have the same distribution. 
...
Answer:
```{r}
ggplot(FemPreg[FemPreg$BIRTHWGT_LB1<98,], aes(as.numeric(BIRTHWGT_LB1), ..density..,  linetype=as.factor(RACE), fill=as.factor(RACE))) + 
