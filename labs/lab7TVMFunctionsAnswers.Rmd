...
b.  Create a function that finds the present value a bond (i.e. implements (2a).  In the comments of the function you need to define what the parameters are. (i.e. comments so you know how to use the function in the future.)
