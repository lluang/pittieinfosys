...
2. [4]  Filter on individuals who have positive income (PINCP > 1). Transform the following variables and add them to the ACS Personal Record data frame. Plot separate histogrames of each of the new variables
...
3. [4] Filter on individuals who are employed (based on PINCP > 0).
  ...
  b. Use `data_grid` from the `modelr` package and the model summary to isolate the effect of citizenship. 
  c. Comment on the original statement.

Note: 
  i. Factors from the ACS Person Record that need to be in the model (after transformation) 
