...
athletesaffiliates  %>% 
  ...
  arrange(desc(numberrepeatathletes))
...
An example using histogram. Other options could include scatterplot
...
Here is an example of a plot that shows the individuals rank in both 2018 and 2019

```{r}
ggplot(topaffiliate) + geom_point(aes(x=Overall_rank, y=overallrank)) +
  xlab("Rank in 2018") + 
  ylab("Rank in 2019") +
  ggtitle("Rank of athletes from CrossFit Fig in the 2018 and 2019 CrossFit Open")
```
