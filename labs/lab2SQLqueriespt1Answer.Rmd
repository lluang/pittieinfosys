...
Note: not for this lab, when we get to R we will use the title (Master, Miss) to help identify adults vs. children.  In SQL, the real answer is to use the CAST() function.
