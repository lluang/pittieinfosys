...
4.  (*) In (4), this result is actually NOT in alphabetical (phone book) order.  
    a. Give at least two reasons why you are not able to do this using the SQL you know.
    The names include a title ("Mr.", "Mrs.", etc.).  Married women are listed based on the husband's name.
...
WHERE Age <= "12" 
```
gives 198.  Many of the records do not include the age.
