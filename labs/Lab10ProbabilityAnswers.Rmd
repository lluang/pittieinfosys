...
chemclasses2 <- c()
for (i in 1:nclasses){
  revenue <- classrevenue(nstudents)
  chemclasses2 <- c(chemclasses2, revenue)
}
summary(chemclasses2)
...
```{r}
chemclassesdf <- data.frame(chemclasses)
ggplot(chemclassesdf)+geom_histogram(aes(x=chemclasses)) + xlab("classrevenue") + ylab("results out of 10000 samples")
