...
The residuals for each fare seem to have the same range for most values of the fare.  But their are large differences in the boxplots when plotting against the title, indicating that the title is informative, so add the title.
