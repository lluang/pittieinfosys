...
2）Do not replace the original Age column with NA. The lecture do it for the first 10 row just because there wasn't NA in that column, to show the process we put NA in it.
