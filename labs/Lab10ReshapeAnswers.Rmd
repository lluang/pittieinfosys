...
Note that birthweight\_oz = BIRTHWGT\_LB * 16 + BIRTHWGT\_OZ
...
# Optional
library(reshape)
bfm <- reshape::melt(babyweights, c('BABYDOB_Y','education'), c('birthweight_oz'))
babyweighthieduc<-reshape::cast(bfm, BABYDOB_Y+education~variable, mean, na.rm=TRUE)
```
