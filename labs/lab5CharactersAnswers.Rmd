...
Hint 1: Look in lecture Rmd file
Hint 2: How do you find the first letter? how do you know the title is complete? Note: The Countess is a special case, don't worry about getting her territory right, just her title.  
...
Note 4:  to apply a function to a vector (e.g. a column in a dataframe) use `sapply(dataframe$column, FUN=sqrt)  
