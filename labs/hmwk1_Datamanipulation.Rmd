...
2.  In the subgroup column, there are actually three pieces information: the mode of diagnosis,  gender, and the age range.
  ...
  b. In R, create three new columns 'agerange', 'gender', 'diagnosismode' and populate them based on the current value of subgroup. (note: 'agerange' is going to be the hardest of the three, I suggest starting with 'gender'). Print out the last 6 rows of the table with country, iso3, year, agerange, gender, diagnosismode, cases.


3.  You need a table of rates of annual diagnosis by country for the last 5 years (2009-2013).
