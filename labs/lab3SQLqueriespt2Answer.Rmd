...
```
select TEN, count(SERIALNO), sum(NP) from ss12hpa
GROUP BY TEN
```
...
3.  [3] New York City recently instituted universal Pre-Kindergarden for four year-olds.  What is the fraction of 4/5 year olds in Pre-K?  
