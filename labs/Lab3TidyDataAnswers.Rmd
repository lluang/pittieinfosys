...
2. [4]  What steps need to be taken make the who data tidy? Do so using R and save the results to the data frame `tidywho`. (note: you may leave the labels as they are, you do not have to rewrite the age ranges) In addition to R code, you can answer in a list of steps, or draw a flow chart/process map of the steps. Display the last 10 rows.
