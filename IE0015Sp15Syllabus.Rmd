...
5.  Introduction to Probability and Statistics Using R
...
- Module 8: Complex graphs with ggplot2 (qplot)
- MIDTERM March 4
- Module 9: Data manipulation with plyr (based on Spect Ch 8, 9)
...
- Module 13: Statistical analysis (linear regression and sampling/Simulation) (based on IPSUR)
