...
\begin{parts}
\part   Create a CoNVO statement from the point of view of an analyst assisting the WPC in identifying some of Pittsburgh's 91 neighborhoods to focus future efforts.
...
\begin{parts}
  \part Design and sketch a visualization that shows:
      ...
      2.  Distribution of trees within the public works division.
