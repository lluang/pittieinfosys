...
```{r}
mlb1 <- mlbBat10
mlb1[which(is.na(mlb1$position)),] <- mean(x, na.rm=TRUE)
```
...
```{r}
iris2 <- kNN(iris)
iris2[1:10, c('Sepal.Length', 'Sepal.Width', 'Petal.Length', 'Petal.Width', 'Species', 'Sepal.Length_imp')]
```
