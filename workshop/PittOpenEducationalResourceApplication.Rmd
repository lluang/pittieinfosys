...
For example, chapter 2 of ModernDive is about getting started with data in R.  Instead of R and R Studio, this will be an introduction to Python, the Python Package Library, and the Spyder IDE. Instead of the 
