...
1.  Form team and propose topic. Identify a data set(s) and a potential CoNVO - February 7
...
2.  Exploratory data analysis - March 14
  -  Two initial graphical view of data set.  There should be at least three dependent variables in each.
  ...
  -  Refine CoNVO
3.  Final Report April 18. Final report should be no more than 6 pages.  Use the format of the Freshman Conference.  Presentations April 19, 20 in lab (note: if teammates are in different lab sessions, I will pick one to present in)
