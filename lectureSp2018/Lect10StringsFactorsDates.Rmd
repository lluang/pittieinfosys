---
title: 'Lecture 10: Data Formats: Dates and factors'
...
trashwheel <- HealthyHarborWaterWheelTotals2018_3_1 <- read_excel("C:/Users/louis/Downloads/HealthyHarborWaterWheelTotals2018-3-1.xlsx",
...
```{r}
Precipitation2014 <- read_excel("C:/Users/louis/Downloads/HealthyHarborWaterWheelTotals2018-3-1.xlsx",
sheet = "2014 Precipitation", skip = 1)
Precipitation2014 <- Precipitation2014 %>% filter(!is.na(Month))
Precipitation2015 <- read_excel("C:/Users/louis/Downloads/HealthyHarborWaterWheelTotals2018-3-1.xlsx",
sheet = "2015 Precipitation", skip = 1)
Precipitation2015 <- Precipitation2015 %>% filter(!is.na(Month))
Precipitation2016 <- read_excel("C:/Users/louis/Downloads/HealthyHarborWaterWheelTotals2018-3-1.xlsx",
sheet = "2016 Precipitation", skip = 1)
Precipitation2016 <- Precipitation2016 %>% filter(!is.na(Month))
Precipitation2017 <- read_excel("C:/Users/louis/Downloads/HealthyHarborWaterWheelTotals2018-3-1.xlsx",
