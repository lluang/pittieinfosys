...
- Web based dashboard are provided by R Shiny
- Works with displaying data that is in dataframes
- Allows for user input parameters to change data display dynamically.
- Web interface, so web designers know how to create a standardized look and feel.
...
- Most people know of R as a data analysis and *statistics* platform
- Linear regression
