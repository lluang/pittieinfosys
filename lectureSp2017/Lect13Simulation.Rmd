...
$$\frac{dI}{dt} = \lambda I S - v I$$

$$\frac{dR}{dT} = vI$$

-Where
  - $\lambda$ is the force of infection, where $\lambda$ is a function of the contact rate, the probability of transmission per contact, and the total population,
...
Same model in R using the `FME` package
=======
...
- We will parameterize this system of equations for an epidemic that occured in an English boarding school.
