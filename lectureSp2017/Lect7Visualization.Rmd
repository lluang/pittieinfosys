...
- For using R with databases, everything in the Spector book chapter 3 applies.
- For all references to MySQL, you can think of SQLite in its place.
- This holds true for all Relational Database Management Systems.
- Section 2.11, 3.2, 3.3 discuss ODBC.  Note that we are using the XLConnect package to work with Excel, but everything here applies to using MS Access. 

Schedule order
================

-  We are introducing plots now.
-  Next data formats (dates, factors, matrices, data frames)
-  Return to plots later.
...
The range of types of visualizations (more seriously)
====================================

![Chart Types](figures/ChartsuggestionsTosi2009.jpg)
