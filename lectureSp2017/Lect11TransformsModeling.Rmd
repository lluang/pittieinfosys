...
- Centering and scaling (e.g. converting to standard normal subtracting from a mean and dividing by standard deviation)
...
-  Look at log-log plot of carat vs price (transform) to make it linear
-  So we know that carat (size) is a determinant of price, but what about other things?
-  Let's remove the effect of carat
